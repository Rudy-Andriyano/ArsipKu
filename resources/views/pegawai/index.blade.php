    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="table-responsive text-nowrap">
                            ...
                            <td>
                                ...
                                <form action="{{ route('pegawai.updateStatus', $pegawai->id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                            ...
                            <td>{{$pegawai->unit_kerja}}</td>
                                <td>
                                    ...
                                    <a href="#editCategoryModal{{$pegawai->id}}" data-bs-toggle="modal"class="dropdown-item"> 
                                    <i class="bx bx-edit-alt me-2"></i> Edit</a>
                                    <form action="{{ route('pegawai.destroy', $pegawai->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="dropdown-item" onclick="return confirm('Apakah Yakin Ingin Menghapus Data?')">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('pegawai.store')}}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="nik" class="form-label">UNIT KERJA</label>
            ...
            @foreach ($pegawais as $pegawai)
            <div class="modal fade" id="editCategoryModal{{$pegawai->id}}" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input name="jenis_kelamin" class="form-check-input" type="radio" value="pria" id="defaultRadio1"
                                {{$pegawai->jenis_kelamin == 'pria' ? 'checked':''}} >
                                <label class="form-check-label" for="defaultRadio1"> Laki - Laki </label>
                            </div>
                            <div class="form-check">
                                <input name="jenis_kelamin" class="form-check-input" type="radio" value="perempuan" id="defaultRadio1"
                        ...
                        <div class="mb-3">
                            <label for="nik" class="form-label">No Hp</label>
                            <input type="text" class="form-control" name="nomor_hp" value="{{$pegawai->nomor_hp}}"/>
                        </div>
                        <div class="modal_footer mb-3">
                            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Batal</button>
