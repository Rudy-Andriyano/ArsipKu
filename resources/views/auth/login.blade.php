              ...
              <div class="app-brand justify-content-center">
                <a href="{{ route('login') }}" class="app-brand-link gap-2 d-flex flex-column align-items-center text-decoration-none">
                  ...
                  <div class="text-center mt-2">
                      <span class="app-brand-text text-body fw-bold fs-4">Arsip</span><br>
                      <p class="text-muted fw-large">Dinas Kependudukan dan Catatan Sipil</p>
                  </div>
              </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang Di Aplikasi Peminjaman Arsip</h4>
